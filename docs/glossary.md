...
* Cherry
* Clack – (стук, треск) неформальный термин, означающий звук при нажатии клавиши. В реальности при быстрой печати мы делаем не нажатие, а удар по клавише, при этом результирующий звук состоит из нескольких составляющих. Это звук удара слайдера о дно корпуса переключателя, удар кейкапа о верхнюю часть корпуса переключателя, удар при возвращении слайдера в исходное положение, а так же звук (click) при наличии специального механизма щелчка если это кликающий переключатель. Резкий звук ударов, особенно на контрасте с мембранными или купольными клавиатурами, ошибочно принимается новичками за звук щелчка (click). Монтажная металлическая пластина (plate) дополнительно усиливает звук ударов.
...
* Doubleshot – так же [two-shot molding](https://en.wikipedia.org/wiki/Keycap#History), метод нанесения символов на кейкап с помощью двух и более слоёв пластика разного цвета, в противовес массово производящимся кейкапам из пластика одного цвета.
