...
* Bump - (бамп) выпуклость. В тактильных переключателях это своеобразная ступенька, которую нужно преодолевать при продавливании клавиши и само ощущение тактильной отдачи, как небольшой удар. Также это бугорок (точка, засечка, чёрточка, пумпочка) на клавишах F и J, на которых располагаются указательные пальцы в начальной позиции при слепой печати.
...
* CNC - Computer Numerical Control, ЧПУ станок. Обычно упоминается в контексте изготавливаемых на них корпусов из цельного куска алюминия или поликарбоната.
...
* Housing - обычно switch housing, корпус переключателя.
...
* Tilt and tent - наклон клавиатуры, позитивный тилт - ближняя сторона ниже дальней (как на печатных машинках), негативный тилт - наклон в обратную сторону, а тент - это когда внутренняя сторона половины сплит клавиатуры выше внешней. Наклон улучшает эргономику и позволяет привести запястья в прямое положение, что должно устранить спазмы от статического перенапряжения в неудобной позе и упростить доступ к неудобным клавишам.
...
* Wobble - (вобл) колебание, шатание кейкапа или штока (стэма) относительно корпуса переключателя.
